...
int main(){
    puts("---uc_mode---");
    printf("UC_MODE_LITTLE_ENDIAN : 0x%x\n",UC_MODE_LITTLE_ENDIAN);
    printf("UC_MODE_BIG_ENDIAN : 0x%x\n",UC_MODE_BIG_ENDIAN);
    printf("UC_MODE_ARM : 0x%x\n",UC_MODE_ARM);
    printf("UC_MODE_THUMB : 0x%x\n",UC_MODE_THUMB);
    printf("UC_MODE_MCLASS : 0x%x\n",UC_MODE_MCLASS);
    printf("UC_MODE_V8 : 0x%x\n",UC_MODE_V8);
    printf("UC_MODE_ARMBE8 : 0x%x\n",UC_MODE_ARMBE8);
    printf("UC_MODE_ARM926 : 0x%x\n",UC_MODE_ARM926);
    printf("UC_MODE_ARM946 : 0x%x\n",UC_MODE_ARM946);
    printf("UC_MODE_ARM1176 : 0x%x\n",UC_MODE_ARM1176);
    printf("UC_MODE_MICRO : 0x%x\n",UC_MODE_MICRO);
    printf("UC_MODE_MIPS3 : 0x%x\n",UC_MODE_MIPS3);
    printf("UC_MODE_MIPS32R6 : 0x%x\n",UC_MODE_MIPS32R6);
    printf("UC_MODE_MIPS32 : 0x%x\n",UC_MODE_MIPS32);
    printf("UC_MODE_MIPS64 : 0x%x\n",UC_MODE_MIPS64);
    printf("UC_MODE_16 : 0x%x\n",UC_MODE_16);
    printf("UC_MODE_32 : 0x%x\n",UC_MODE_32);
    printf("UC_MODE_64 : 0x%x\n",UC_MODE_64);
    printf("UC_MODE_PPC32 : 0x%x\n",UC_MODE_PPC32);
    printf("UC_MODE_PPC64 : 0x%x\n",UC_MODE_PPC64);
    printf("UC_MODE_QPX : 0x%x\n",UC_MODE_QPX);
    printf("UC_MODE_SPARC32 : 0x%x\n",UC_MODE_SPARC32);
    printf("UC_MODE_SPARC64 : 0x%x\n",UC_MODE_SPARC64);
    printf("UC_MODE_V9 : 0x%x\n",UC_MODE_V9);
    printf("UC_MODE_RISCV32 : 0x%x\n",UC_MODE_RISCV32);
    printf("UC_MODE_RISCV64 : 0x%x\n",UC_MODE_RISCV64);
    puts("---uc_arch---");
    printf("UC_ARCH_ARM : 0x%x\n",UC_ARCH_ARM);
    printf("UC_ARCH_ARM64 : 0x%x\n",UC_ARCH_ARM64);
    printf("UC_ARCH_MIPS : 0x%x\n",UC_ARCH_MIPS);
    printf("UC_ARCH_X86 : 0x%x\n",UC_ARCH_X86);
    printf("UC_ARCH_PPC : 0x%x\n",UC_ARCH_PPC);
    printf("UC_ARCH_SPARC : 0x%x\n",UC_ARCH_SPARC);
    printf("UC_ARCH_M68K : 0x%x\n",UC_ARCH_M68K);
    printf("UC_ARCH_RISCV : 0x%x\n",UC_ARCH_RISCV);
    printf("UC_ARCH_S390X : 0x%x\n",UC_ARCH_S390X);
    printf("UC_ARCH_TRICORE : 0x%x\n",UC_ARCH_TRICORE);
    printf("UC_ARCH_MAX : 0x%x\n",UC_ARCH_MAX);
    printf("UC_X86_INS_SYSCALL : 0x%x\n",UC_X86_INS_SYSCALL);
        printf("UC_X86_REG_INVALI : 0x%x\n",UC_X86_REG_INVALID);
    printf("UC_X86_REG_AH : 0x%x\n",UC_X86_REG_AH);
    printf("UC_X86_REG_AL : 0x%x\n",UC_X86_REG_AL);
    printf("UC_X86_REG_AX : 0x%x\n",UC_X86_REG_AX);
    printf("UC_X86_REG_BH : 0x%x\n",UC_X86_REG_BH);
    printf("UC_X86_REG_BL : 0x%x\n",UC_X86_REG_BL);
    printf("UC_X86_REG_BP : 0x%x\n",UC_X86_REG_BP);
    printf("UC_X86_REG_BPL : 0x%x\n",UC_X86_REG_BPL);
    printf("UC_X86_REG_BX : 0x%x\n",UC_X86_REG_BX);
    printf("UC_X86_REG_CH : 0x%x\n",UC_X86_REG_CH);
    printf("UC_X86_REG_CL : 0x%x\n",UC_X86_REG_CL);
    printf("UC_X86_REG_CS : 0x%x\n",UC_X86_REG_CS);
    printf("UC_X86_REG_CX : 0x%x\n",UC_X86_REG_CX);
    printf("UC_X86_REG_DH : 0x%x\n",UC_X86_REG_DH);
    printf("UC_X86_REG_DI : 0x%x\n",UC_X86_REG_DI);
    printf("UC_X86_REG_DIL : 0x%x\n",UC_X86_REG_DIL);
    printf("UC_X86_REG_DL : 0x%x\n",UC_X86_REG_DL);
    printf("UC_X86_REG_DS : 0x%x\n",UC_X86_REG_DS);
    printf("UC_X86_REG_DX : 0x%x\n",UC_X86_REG_DX);
    printf("UC_X86_REG_EAX : 0x%x\n",UC_X86_REG_EAX);
    printf("UC_X86_REG_EBP : 0x%x\n",UC_X86_REG_EBP);
    printf("UC_X86_REG_EBX : 0x%x\n",UC_X86_REG_EBX);
    printf("UC_X86_REG_ECX : 0x%x\n",UC_X86_REG_ECX);
    printf("UC_X86_REG_EDI : 0x%x\n",UC_X86_REG_EDI);
    printf("UC_X86_REG_EDX : 0x%x\n",UC_X86_REG_EDX);
    printf("UC_X86_REG_EFLAGS : 0x%x\n",UC_X86_REG_EFLAGS);
    printf("UC_X86_REG_EIP : 0x%x\n",UC_X86_REG_EIP);
    printf("UC_X86_REG_E : 0x%x\n",UC_X86_REG_ES);
    printf("UC_X86_REG_EI : 0x%x\n",UC_X86_REG_EIP);
    printf("UC_X86_REG_ESI : 0x%x\n",UC_X86_REG_ESI);
    printf("UC_X86_REG_ESP : 0x%x\n",UC_X86_REG_ESP);
    printf("UC_X86_REG_FPSW : 0x%x\n",UC_X86_REG_FPSW);
    printf("UC_X86_REG_FS : 0x%x\n",UC_X86_REG_FS);
    printf("UC_X86_REG_GS : 0x%x\n",UC_X86_REG_GS);
    printf("UC_X86_REG_IP : 0x%x\n",UC_X86_REG_IP);
    printf("UC_X86_REG_RAX : 0x%x\n",UC_X86_REG_RAX);
    printf("UC_X86_REG_RBP : 0x%x\n",UC_X86_REG_RBP);
    printf("UC_X86_REG_RBX : 0x%x\n",UC_X86_REG_RBX);
    printf("UC_X86_REG_RCX : 0x%x\n",UC_X86_REG_RCX);
    printf("UC_X86_REG_RDI : 0x%x\n",UC_X86_REG_RDI);
    printf("UC_X86_REG_RDX : 0x%x\n",UC_X86_REG_RDX);
    printf("UC_X86_REG_RIP : 0x%x\n",UC_X86_REG_RIP);
    printf("UC_X86_REG_RS : 0x%x\n",UC_X86_REG_RSI);
    printf("UC_X86_REG_RI : 0x%x\n",UC_X86_REG_RIP);
    printf("UC_X86_REG_RSP : 0x%x\n",UC_X86_REG_RSP);
    printf("UC_X86_REG_SI : 0x%x\n",UC_X86_REG_SI);
    printf("UC_X86_REG_SIL : 0x%x\n",UC_X86_REG_SIL);
    printf("UC_X86_REG_SP : 0x%x\n",UC_X86_REG_SP);
    printf("UC_X86_REG_SPL : 0x%x\n",UC_X86_REG_SPL);
    printf("UC_X86_REG_SS : 0x%x\n",UC_X86_REG_SS);
    printf("UC_X86_REG_CR0 : 0x%x\n",UC_X86_REG_CR0);
    printf("UC_X86_REG_CR1 : 0x%x\n",UC_X86_REG_CR1);
    printf("UC_X86_REG_CR2 : 0x%x\n",UC_X86_REG_CR2);
    printf("UC_X86_REG_CR3 : 0x%x\n",UC_X86_REG_CR3);
    printf("UC_X86_REG_CR4 : 0x%x\n",UC_X86_REG_CR4);
    printf("UC_X86_REG_CR : 0x%x\n",UC_X86_REG_CR8);
    printf("UC_X86_REG_CR : 0x%x\n",UC_X86_REG_CR4);
    printf("UC_X86_REG_DR : 0x%x\n",UC_X86_REG_DR0);
    printf("UC_X86_REG_CR : 0x%x\n",UC_X86_REG_CR8);
    printf("UC_X86_REG_DR1 : 0x%x\n",UC_X86_REG_DR1);
    printf("UC_X86_REG_DR2 : 0x%x\n",UC_X86_REG_DR2);
    printf("UC_X86_REG_DR3 : 0x%x\n",UC_X86_REG_DR3);
    printf("UC_X86_REG_DR4 : 0x%x\n",UC_X86_REG_DR4);
    printf("UC_X86_REG_DR5 : 0x%x\n",UC_X86_REG_DR5);
    printf("UC_X86_REG_DR6 : 0x%x\n",UC_X86_REG_DR6);
    printf("UC_X86_REG_DR7 : 0x%x\n",UC_X86_REG_DR7);
    printf("UC_X86_REG_FP : 0x%x\n",UC_X86_REG_FP0);
    printf("UC_X86_REG_DR : 0x%x\n",UC_X86_REG_DR7);
    printf("UC_X86_REG_FP1 : 0x%x\n",UC_X86_REG_FP1);
    printf("UC_X86_REG_FP2 : 0x%x\n",UC_X86_REG_FP2);
    printf("UC_X86_REG_FP3 : 0x%x\n",UC_X86_REG_FP3);
    printf("UC_X86_REG_FP4 : 0x%x\n",UC_X86_REG_FP4);
    printf("UC_X86_REG_FP5 : 0x%x\n",UC_X86_REG_FP5);
    printf("UC_X86_REG_FP6 : 0x%x\n",UC_X86_REG_FP6);
    printf("UC_X86_REG_FP7 : 0x%x\n",UC_X86_REG_FP7);
    printf("UC_X86_REG_K0 : 0x%x\n",UC_X86_REG_K0);
    printf("UC_X86_REG_K1 : 0x%x\n",UC_X86_REG_K1);
    printf("UC_X86_REG_K2 : 0x%x\n",UC_X86_REG_K2);
    printf("UC_X86_REG_K3 : 0x%x\n",UC_X86_REG_K3);
    printf("UC_X86_REG_K4 : 0x%x\n",UC_X86_REG_K4);
    printf("UC_X86_REG_K5 : 0x%x\n",UC_X86_REG_K5);
    printf("UC_X86_REG_K6 : 0x%x\n",UC_X86_REG_K6);
    printf("UC_X86_REG_K7 : 0x%x\n",UC_X86_REG_K7);
    printf("UC_X86_REG_MM0 : 0x%x\n",UC_X86_REG_MM0);
    printf("UC_X86_REG_MM1 : 0x%x\n",UC_X86_REG_MM1);
    printf("UC_X86_REG_MM2 : 0x%x\n",UC_X86_REG_MM2);
    printf("UC_X86_REG_MM3 : 0x%x\n",UC_X86_REG_MM3);
    printf("UC_X86_REG_MM4 : 0x%x\n",UC_X86_REG_MM4);
    printf("UC_X86_REG_MM5 : 0x%x\n",UC_X86_REG_MM5);
    printf("UC_X86_REG_MM6 : 0x%x\n",UC_X86_REG_MM6);
    printf("UC_X86_REG_MM7 : 0x%x\n",UC_X86_REG_MM7);
    printf("UC_X86_REG_R8 : 0x%x\n",UC_X86_REG_R8);
    printf("UC_X86_REG_R9 : 0x%x\n",UC_X86_REG_R9);
    printf("UC_X86_REG_R10 : 0x%x\n",UC_X86_REG_R10);
    printf("UC_X86_REG_R11 : 0x%x\n",UC_X86_REG_R11);
    printf("UC_X86_REG_R12 : 0x%x\n",UC_X86_REG_R12);
    printf("UC_X86_REG_R13 : 0x%x\n",UC_X86_REG_R13);
    printf("UC_X86_REG_R14 : 0x%x\n",UC_X86_REG_R14);
    printf("UC_X86_REG_R15 : 0x%x\n",UC_X86_REG_R15);
    printf("UC_X86_REG_ST0 : 0x%x\n",UC_X86_REG_ST0);
    printf("UC_X86_REG_ST1 : 0x%x\n",UC_X86_REG_ST1);
    printf("UC_X86_REG_ST2 : 0x%x\n",UC_X86_REG_ST2);
    printf("UC_X86_REG_ST3 : 0x%x\n",UC_X86_REG_ST3);
    printf("UC_X86_REG_ST4 : 0x%x\n",UC_X86_REG_ST4);
    printf("UC_X86_REG_ST5 : 0x%x\n",UC_X86_REG_ST5);
    printf("UC_X86_REG_ST6 : 0x%x\n",UC_X86_REG_ST6);
    printf("UC_X86_REG_ST7 : 0x%x\n",UC_X86_REG_ST7);
    printf("UC_X86_REG_XMM0 : 0x%x\n",UC_X86_REG_XMM0);
    printf("UC_X86_REG_XMM1 : 0x%x\n",UC_X86_REG_XMM1);
    printf("UC_X86_REG_XMM2 : 0x%x\n",UC_X86_REG_XMM2);
    printf("UC_X86_REG_XMM3 : 0x%x\n",UC_X86_REG_XMM3);
    printf("UC_X86_REG_XMM4 : 0x%x\n",UC_X86_REG_XMM4);
    printf("UC_X86_REG_XMM5 : 0x%x\n",UC_X86_REG_XMM5);
    printf("UC_X86_REG_XMM6 : 0x%x\n",UC_X86_REG_XMM6);
    printf("UC_X86_REG_XMM7 : 0x%x\n",UC_X86_REG_XMM7);
    printf("UC_X86_REG_XMM8 : 0x%x\n",UC_X86_REG_XMM8);
    printf("UC_X86_REG_XMM9 : 0x%x\n",UC_X86_REG_XMM9);
    printf("UC_X86_REG_XMM10 : 0x%x\n",UC_X86_REG_XMM10);
    printf("UC_X86_REG_XMM11 : 0x%x\n",UC_X86_REG_XMM11);
    printf("UC_X86_REG_XMM12 : 0x%x\n",UC_X86_REG_XMM12);
    printf("UC_X86_REG_XMM13 : 0x%x\n",UC_X86_REG_XMM13);
    printf("UC_X86_REG_XMM14 : 0x%x\n",UC_X86_REG_XMM14);
    printf("UC_X86_REG_XMM15 : 0x%x\n",UC_X86_REG_XMM15);
    printf("UC_X86_REG_XMM16 : 0x%x\n",UC_X86_REG_XMM16);
    printf("UC_X86_REG_XMM17 : 0x%x\n",UC_X86_REG_XMM17);
    printf("UC_X86_REG_XMM18 : 0x%x\n",UC_X86_REG_XMM18);
    printf("UC_X86_REG_XMM19 : 0x%x\n",UC_X86_REG_XMM19);
    printf("UC_X86_REG_XMM20 : 0x%x\n",UC_X86_REG_XMM20);
    printf("UC_X86_REG_XMM21 : 0x%x\n",UC_X86_REG_XMM21);
    printf("UC_X86_REG_XMM22 : 0x%x\n",UC_X86_REG_XMM22);
    printf("UC_X86_REG_XMM23 : 0x%x\n",UC_X86_REG_XMM23);
    printf("UC_X86_REG_XMM24 : 0x%x\n",UC_X86_REG_XMM24);
    printf("UC_X86_REG_XMM25 : 0x%x\n",UC_X86_REG_XMM25);
    printf("UC_X86_REG_XMM26 : 0x%x\n",UC_X86_REG_XMM26);
    printf("UC_X86_REG_XMM27 : 0x%x\n",UC_X86_REG_XMM27);
    printf("UC_X86_REG_XMM28 : 0x%x\n",UC_X86_REG_XMM28);
    printf("UC_X86_REG_XMM29 : 0x%x\n",UC_X86_REG_XMM29);
    printf("UC_X86_REG_XMM30 : 0x%x\n",UC_X86_REG_XMM30);
    printf("UC_X86_REG_XMM31 : 0x%x\n",UC_X86_REG_XMM31);
    printf("UC_X86_REG_YMM0 : 0x%x\n",UC_X86_REG_YMM0);
    printf("UC_X86_REG_YMM1 : 0x%x\n",UC_X86_REG_YMM1);
    printf("UC_X86_REG_YMM2 : 0x%x\n",UC_X86_REG_YMM2);
    printf("UC_X86_REG_YMM3 : 0x%x\n",UC_X86_REG_YMM3);
    printf("UC_X86_REG_YMM4 : 0x%x\n",UC_X86_REG_YMM4);
    printf("UC_X86_REG_YMM5 : 0x%x\n",UC_X86_REG_YMM5);
    printf("UC_X86_REG_YMM6 : 0x%x\n",UC_X86_REG_YMM6);
    printf("UC_X86_REG_YMM7 : 0x%x\n",UC_X86_REG_YMM7);
    printf("UC_X86_REG_YMM8 : 0x%x\n",UC_X86_REG_YMM8);
    printf("UC_X86_REG_YMM9 : 0x%x\n",UC_X86_REG_YMM9);
    printf("UC_X86_REG_YMM10 : 0x%x\n",UC_X86_REG_YMM10);
    printf("UC_X86_REG_YMM11 : 0x%x\n",UC_X86_REG_YMM11);
    printf("UC_X86_REG_YMM12 : 0x%x\n",UC_X86_REG_YMM12);
    printf("UC_X86_REG_YMM13 : 0x%x\n",UC_X86_REG_YMM13);
    printf("UC_X86_REG_YMM14 : 0x%x\n",UC_X86_REG_YMM14);
    printf("UC_X86_REG_YMM15 : 0x%x\n",UC_X86_REG_YMM15);
    printf("UC_X86_REG_YMM16 : 0x%x\n",UC_X86_REG_YMM16);
    printf("UC_X86_REG_YMM17 : 0x%x\n",UC_X86_REG_YMM17);
    printf("UC_X86_REG_YMM18 : 0x%x\n",UC_X86_REG_YMM18);
    printf("UC_X86_REG_YMM19 : 0x%x\n",UC_X86_REG_YMM19);
    printf("UC_X86_REG_YMM20 : 0x%x\n",UC_X86_REG_YMM20);
    printf("UC_X86_REG_YMM21 : 0x%x\n",UC_X86_REG_YMM21);
    printf("UC_X86_REG_YMM22 : 0x%x\n",UC_X86_REG_YMM22);
    printf("UC_X86_REG_YMM23 : 0x%x\n",UC_X86_REG_YMM23);
    printf("UC_X86_REG_YMM24 : 0x%x\n",UC_X86_REG_YMM24);
    printf("UC_X86_REG_YMM25 : 0x%x\n",UC_X86_REG_YMM25);
    printf("UC_X86_REG_YMM26 : 0x%x\n",UC_X86_REG_YMM26);
    printf("UC_X86_REG_YMM27 : 0x%x\n",UC_X86_REG_YMM27);
    printf("UC_X86_REG_YMM28 : 0x%x\n",UC_X86_REG_YMM28);
    printf("UC_X86_REG_YMM29 : 0x%x\n",UC_X86_REG_YMM29);
    printf("UC_X86_REG_YMM30 : 0x%x\n",UC_X86_REG_YMM30);
    printf("UC_X86_REG_YMM31 : 0x%x\n",UC_X86_REG_YMM31);
    printf("UC_X86_REG_ZMM0 : 0x%x\n",UC_X86_REG_ZMM0);
    printf("UC_X86_REG_ZMM1 : 0x%x\n",UC_X86_REG_ZMM1);
    printf("UC_X86_REG_ZMM2 : 0x%x\n",UC_X86_REG_ZMM2);
    printf("UC_X86_REG_ZMM3 : 0x%x\n",UC_X86_REG_ZMM3);
    printf("UC_X86_REG_ZMM4 : 0x%x\n",UC_X86_REG_ZMM4);
    printf("UC_X86_REG_ZMM5 : 0x%x\n",UC_X86_REG_ZMM5);
    printf("UC_X86_REG_ZMM6 : 0x%x\n",UC_X86_REG_ZMM6);
    printf("UC_X86_REG_ZMM7 : 0x%x\n",UC_X86_REG_ZMM7);
    printf("UC_X86_REG_ZMM8 : 0x%x\n",UC_X86_REG_ZMM8);
    printf("UC_X86_REG_ZMM9 : 0x%x\n",UC_X86_REG_ZMM9);
    printf("UC_X86_REG_ZMM10 : 0x%x\n",UC_X86_REG_ZMM10);
    printf("UC_X86_REG_ZMM11 : 0x%x\n",UC_X86_REG_ZMM11);
    printf("UC_X86_REG_ZMM12 : 0x%x\n",UC_X86_REG_ZMM12);
    printf("UC_X86_REG_ZMM13 : 0x%x\n",UC_X86_REG_ZMM13);
    printf("UC_X86_REG_ZMM14 : 0x%x\n",UC_X86_REG_ZMM14);
    printf("UC_X86_REG_ZMM15 : 0x%x\n",UC_X86_REG_ZMM15);
    printf("UC_X86_REG_ZMM16 : 0x%x\n",UC_X86_REG_ZMM16);
    printf("UC_X86_REG_ZMM17 : 0x%x\n",UC_X86_REG_ZMM17);
    printf("UC_X86_REG_ZMM18 : 0x%x\n",UC_X86_REG_ZMM18);
    printf("UC_X86_REG_ZMM19 : 0x%x\n",UC_X86_REG_ZMM19);
    printf("UC_X86_REG_ZMM20 : 0x%x\n",UC_X86_REG_ZMM20);
    printf("UC_X86_REG_ZMM21 : 0x%x\n",UC_X86_REG_ZMM21);
    printf("UC_X86_REG_ZMM22 : 0x%x\n",UC_X86_REG_ZMM22);
    printf("UC_X86_REG_ZMM23 : 0x%x\n",UC_X86_REG_ZMM23);
    printf("UC_X86_REG_ZMM24 : 0x%x\n",UC_X86_REG_ZMM24);
    printf("UC_X86_REG_ZMM25 : 0x%x\n",UC_X86_REG_ZMM25);
    printf("UC_X86_REG_ZMM26 : 0x%x\n",UC_X86_REG_ZMM26);
    printf("UC_X86_REG_ZMM27 : 0x%x\n",UC_X86_REG_ZMM27);
    printf("UC_X86_REG_ZMM28 : 0x%x\n",UC_X86_REG_ZMM28);
    printf("UC_X86_REG_ZMM29 : 0x%x\n",UC_X86_REG_ZMM29);
    printf("UC_X86_REG_ZMM30 : 0x%x\n",UC_X86_REG_ZMM30);
    printf("UC_X86_REG_ZMM31 : 0x%x\n",UC_X86_REG_ZMM31);
    printf("UC_X86_REG_R8B : 0x%x\n",UC_X86_REG_R8B);
    printf("UC_X86_REG_R9B : 0x%x\n",UC_X86_REG_R9B);
    printf("UC_X86_REG_R10B : 0x%x\n",UC_X86_REG_R10B);
    printf("UC_X86_REG_R11B : 0x%x\n",UC_X86_REG_R11B);
    printf("UC_X86_REG_R12B : 0x%x\n",UC_X86_REG_R12B);
    printf("UC_X86_REG_R13B : 0x%x\n",UC_X86_REG_R13B);
    printf("UC_X86_REG_R14B : 0x%x\n",UC_X86_REG_R14B);
    printf("UC_X86_REG_R15B : 0x%x\n",UC_X86_REG_R15B);
    printf("UC_X86_REG_R8D : 0x%x\n",UC_X86_REG_R8D);
    printf("UC_X86_REG_R9D : 0x%x\n",UC_X86_REG_R9D);
    printf("UC_X86_REG_R10D : 0x%x\n",UC_X86_REG_R10D);
    printf("UC_X86_REG_R11D : 0x%x\n",UC_X86_REG_R11D);
    printf("UC_X86_REG_R12D : 0x%x\n",UC_X86_REG_R12D);
    printf("UC_X86_REG_R13D : 0x%x\n",UC_X86_REG_R13D);
    printf("UC_X86_REG_R14D : 0x%x\n",UC_X86_REG_R14D);
    printf("UC_X86_REG_R15D : 0x%x\n",UC_X86_REG_R15D);
    printf("UC_X86_REG_R8W : 0x%x\n",UC_X86_REG_R8W);
    printf("UC_X86_REG_R9W : 0x%x\n",UC_X86_REG_R9W);
    printf("UC_X86_REG_R10W : 0x%x\n",UC_X86_REG_R10W);
    printf("UC_X86_REG_R11W : 0x%x\n",UC_X86_REG_R11W);
    printf("UC_X86_REG_R12W : 0x%x\n",UC_X86_REG_R12W);
    printf("UC_X86_REG_R13W : 0x%x\n",UC_X86_REG_R13W);
    printf("UC_X86_REG_R14W : 0x%x\n",UC_X86_REG_R14W);
    printf("UC_X86_REG_R15W : 0x%x\n",UC_X86_REG_R15W);
    printf("UC_X86_REG_IDTR : 0x%x\n",UC_X86_REG_IDTR);
    printf("UC_X86_REG_GDTR : 0x%x\n",UC_X86_REG_GDTR);
    printf("UC_X86_REG_LDTR : 0x%x\n",UC_X86_REG_LDTR);
    printf("UC_X86_REG_TR : 0x%x\n",UC_X86_REG_TR);
    printf("UC_X86_REG_FPCW : 0x%x\n",UC_X86_REG_FPCW);
    printf("UC_X86_REG_FPTAG : 0x%x\n",UC_X86_REG_FPTAG);
    printf("UC_X86_REG_MSR : 0x%x\n",UC_X86_REG_MSR);
    printf("UC_X86_REG_MXCSR : 0x%x\n",UC_X86_REG_MXCSR);
    printf("UC_X86_REG_FS_BASE : 0x%x\n",UC_X86_REG_FS_BASE);
    printf("UC_X86_REG_GS_BASE : 0x%x\n",UC_X86_REG_GS_BASE);
    printf("UC_X86_REG_FLAGS : 0x%x\n",UC_X86_REG_FLAGS);
    printf("UC_X86_REG_RFLAGS : 0x%x\n",UC_X86_REG_RFLAGS);
    printf("UC_X86_REG_FIP : 0x%x\n",UC_X86_REG_FIP);
    printf("UC_X86_REG_FCS : 0x%x\n",UC_X86_REG_FCS);
    printf("UC_X86_REG_FDP : 0x%x\n",UC_X86_REG_FDP);
    printf("UC_X86_REG_FDS : 0x%x\n",UC_X86_REG_FDS);
    printf("UC_X86_REG_FOP : 0x%x\n",UC_X86_REG_FOP);
    printf("UC_X86_REG_ENDIN : 0x%x\n",UC_X86_REG_ENDING);
}
